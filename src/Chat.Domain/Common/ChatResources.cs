namespace Chat.Domain.Common
{
    public class ChatResources
    {
        ...
        public const string MsgInformeEmailDoContato = "Informe o e-mail.";
        public const string MsgInformeSenhaDoContato = "Informe a senha.";
        public const string MsgInformeContatoRemetente = "Informe o contato remetente.";
        public const string MsgInformeContatoDestinatario = "Informe o contato destinatário.";
        public const string MsgInformeConversa = "Informe a conversa.";
